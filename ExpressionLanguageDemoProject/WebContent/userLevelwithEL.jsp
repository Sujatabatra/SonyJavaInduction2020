...
User Levels: ${bookInfo.userLevels[0]} - ${bookInfo.userLevels[1]} - ${bookInfo.userLevels[2]}  <br><br>
...
Book Author using EL : ${bookInfo.author.authorName } having ID ${bookInfo["author"].authorId} <br><br>
